...
public CidadeColunasBean() {
	try {
		JFreeChart graficoColunas = ChartFactory.createBarChart("Cinco cidades mais populosas de Santa Catarina", "cidades", "população", this.geraDados(), PlotOrientation.VERTICAL,false, true, false);
	...
	private DefaultCategoryDataset geraDados() {
		...
		dts.setValue(new Double(461524.0), "População", "Florianópolis");
