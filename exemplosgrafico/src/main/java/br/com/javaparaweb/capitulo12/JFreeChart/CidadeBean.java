...
public class CidadeBean {
	...
	public CidadeBean() {
		try {
			JFreeChart graficoPizza = ChartFactory.createPieChart("Cinco cidades mais populosas de Santa Catarina",
	...
	private DefaultPieDataset geraDados() {
		...
		dts.setValue("Blumenal", new Double(334002.0));
		dts.setValue("Criciúma", new Double(204667.0));
		dts.setValue("Florianópolis", new Double(461524.0));
