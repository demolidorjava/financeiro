...
email.setRecipient(Message.RecipientType.TO, new InternetAddress("demolidorjava@gmail.com"));
email.setFrom(new InternetAddress(EMAIL));
email.setSubject("Teste de e-mail usando Gmail");
email.setContent("Alô, comunidade! Estou chegando pra arrebentar. Quem quiser, que me segure!", "text/plain");
...
System.out.println("Envio pelo Gmail realizado com sucesso!");
}
