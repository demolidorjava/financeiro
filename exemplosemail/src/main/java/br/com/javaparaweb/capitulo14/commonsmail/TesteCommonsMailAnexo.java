...
public class TesteCommonsMailAnexo {
	...
	email.setSubject("Teste de e-mail com anexo usando Commons Mail");
	email.setMsg("Testando CommonsMail com anexo");
	 EmailAttachment anexo = new EmailAttachment();
	 anexo.setPath("/temp/texto.txt");
	 anexo.setDisposition(EmailAttachment.ATTACHMENT);
	 email.attach(anexo);
	email.send();
	System.out.println("E-mail e anexo com CommonsMail enviados com sucesso!");
}
}